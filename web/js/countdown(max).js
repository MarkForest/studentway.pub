...
function CDT(){
 ...
 // Set countdown limit
 var curHourse = new Date().getHours();
 var tl = new Date().setHours(curHourse+1);


 // You can add time's up message here
 var timer = new CountdownTimer('CDT',tl,'<span class="number-wrapper"><div class="line"></div><span class="number end">Акція завершена</span></span>');
 timer.countDown();
}
